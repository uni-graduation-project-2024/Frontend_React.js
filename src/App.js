...
import ShowUser from "./pages/admin/show-users/show-user"; // ✅ Only one import here
...
import UserProfile from "./pages/UserProfile/UserProfile"; // ✅ Only one import here
        ...
        <Routes>
          ...
          <Route element={<AuthGuard roles={["User"]}/>}>
            ...
            <Route element={<MainLayout/>}>
              ...
              {/* If user view their own profile in future */}
              ...
              <Route path="/user-profile/:userId" element={<UserProfile />} /> {/* User profile view */}
            </Route>
          </Route>
          ...
          <Route element={<AuthGuard roles={["Admin"]} />}>
            ...
            <Route path="/show-user/:id" element={<ShowUser />} /> {/* ✅ Admin can view any user */}
